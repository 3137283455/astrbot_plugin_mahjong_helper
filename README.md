...
对局与订阅接口目前要求牌谱屋官方授权密钥。取得密钥后可在 AstrBot 配置页填写
`koromo_token`，或由管理员**私聊**机器人：
...
以及旧版最近对局命令在未取得牌谱屋官方授权密钥时会提示接口受限；“基本、顺位、
立直、更多、和铳、血统、大铳”仍可从公开统计接口查询。获取授权密钥后，管理员
可私聊机器人用 `/设置牌谱屋Token 密钥` 配置。
